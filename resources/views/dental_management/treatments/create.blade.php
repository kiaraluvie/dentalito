...
@section('title', __('treatments.title_create'))
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-light border-bottom font-weight-bold">
                    <i class="fas fa-plus"></i> {{ __('treatments.title_create') }}
                </div>
                <div class="card-body">
                    <form action="{{ route('dental_management.treatments.store') }}" method="POST">
                        @csrf
