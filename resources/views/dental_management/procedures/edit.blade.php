...
@section('title', __('procedures.title_edit'))
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-light border-bottom font-weight-bold">
                    <i class="fas fa-pen"></i> {{ __('procedures.title_edit') }}
                </div>
                <div class="card-body">
                    <form action="{{ route('dental_management.procedures.update', $procedure) }}" method="POST">
                        @csrf
                        @method('PUT')
