...
@section('title', __('procedures.title_index'))
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          @include('dental_management.procedures.partials._index_filters')
        </div>
      </div>
    </div>
  </div>    
    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header bg-light border-bottom font-weight-bold">
            ...
            @if ($procedures->total() > 0)<strong>{{ $procedures->total() }}</strong>@else 0 @endif
          <div class="card-tools">
            <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Minimizar">
              <i class="fas fa-minus"></i>
            </button>
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12 text-right pt-0 pb-1">
              ...
              <a class="btn btn-primary" href="{{ route('dental_management.procedures.create') }}">
          ...
          <div class="table-responsive">
            @include('dental_management.procedures.partials._index_results')
          </div>
