...
class LanguageController extends Controller
{
    ...
    {
        $this->middleware('permission:languages.view')->only(['index', 'show', 'exportPdf', 'exportExcel', 'exportWord']);
        $this->middleware('permission:languages.create')->only(['create', 'store']);
        $this->middleware('permission:languages.edit')->only(['edit', 'update', 'updateInline']);
        $this->middleware('permission:languages.delete')->only(['delete', 'deleteSave']);
        $this->middleware('permission:languages.edit_all')->only('editAll');
    }
