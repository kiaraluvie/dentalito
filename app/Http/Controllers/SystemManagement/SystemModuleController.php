...
class SystemModuleController extends Controller
{
    ...
    {
        $this->middleware('permission:system_modules.view')->only(['index', 'show', 'exportExcel', 'exportPdf', 'exportWord']);
        $this->middleware('permission:system_modules.create')->only(['create', 'store', 'storePermission']);
        $this->middleware('permission:system_modules.edit')->only(['edit', 'update', 'updateInline']);
        $this->middleware('permission:system_modules.delete')->only(['delete', 'deleteSave', 'destroyPermission']);
        $this->middleware('permission:system_modules.edit_all')->only('editAll');
    }
