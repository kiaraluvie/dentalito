...
class RegionController extends Controller
{
    ...
    {
        $this->middleware('permission:regions.view')->only(['index', 'show', 'exportExcel', 'exportPdf', 'exportWord']);
        $this->middleware('permission:regions.create')->only(['create', 'store']);
        $this->middleware('permission:regions.edit')->only(['edit', 'update', 'updateInline']);
        $this->middleware('permission:regions.delete')->only(['delete', 'deleteSave']);
        $this->middleware('permission:regions.edit_all')->only('editAll');
    }
