 ...
 *     @OA\Property(property="id", type="integer", format="int64", description="ID of the language"),
 *     @OA\Property(property="name", type="string", description="Name of the language"),
 *     @OA\Property(property="iso_code", type="string", description="ISO code of the language"),
 *     @OA\Property(property="is_active", type="boolean", description="Whether the language is active"),
