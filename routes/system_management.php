...
Route::prefix('system_management')->name('system_management.')->group(function () {
    ...
    Route::get('tenants/{tenant}/api-key-manager', [TenantController::class, 'apiKeyManager'])->name('tenants.api_key_manager');
    Route::post('tenants/{tenant}/generate-api-key', [TenantController::class, 'generateApiKey'])->name('tenants.generate_api_key');
